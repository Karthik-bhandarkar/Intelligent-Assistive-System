...
class ObjectDetectionWithSound:
    ...
    def play_sound_for_class(self, class_name):
        ...
        # Generate audio only once per class (cache in temp dir)
...
if __name__ == "__main__":
    detector = ObjectDetectionWithSound(
        model_path=os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "models", "best.pt"),   # Replace with your actual model
